...
public class Reusable_Actions_Loggers {
    ...
    public static void clickByIndex(WebDriver driver, String locator, int number,ExtentTest logger,String elementName){
        ...
        try{
            ...
            logger.log(LogStatus.FAIL,"Unable to click on element by Index " + elementName + " Error:" + e);
            getScreenShot(driver,elementName,logger);
